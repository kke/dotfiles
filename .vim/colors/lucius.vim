...
if g:lucius_style == "dark"
    ...
    hi Normal       guifg=#d7d7d7   guibg=#101010   ctermfg=188    ctermbg=234       gui=none      cterm=none
    ...
    hi CursorColumn guifg=NONE      guibg=#333333   ctermfg=NONE   ctermbg=232       gui=none      cterm=none
    hi CursorLine   guifg=NONE      guibg=#333333   ctermfg=NONE   ctermbg=232       gui=none      cterm=none
